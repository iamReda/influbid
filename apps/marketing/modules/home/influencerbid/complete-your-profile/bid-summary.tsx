const BidSummary = () => (
	<div
		className="bg-b-subtle95 before:top-0 before:left-36 before:bottom-0 max-3xl:before:left-32 max-2xl:before:left-24 relative z-2 flex grow items-center justify-center overflow-hidden rounded-4xl before:absolute before:z-3 before:w-[1.5px] before:bg-linear-(--gradient-vertical)"
	>
		<div
			className="left-36 -right-10 px-12 py-16 max-3xl:left-32 max-3xl:-right-16 max-2xl:left-24 max-2xl:-right-28 max-2xl:pb-12 after:inset-0 after:bg-b-surface1 absolute top-1/2 min-h-auto -translate-y-1/2 after:absolute after:rounded-l-2xl after:shadow-[-24px_24px_48px_0px_rgba(0,0,0,0.05)]"
		>
			...
			<div
				className="before:top-0 before:-left-36 before:w-360 max-3xl:before:-left-32 max-2xl:before:-left-24 after:bottom-0 after:-left-36 after:w-360 max-3xl:after:-left-32 max-2xl:after:-left-24 pointer-events-none before:absolute before:z-3 before:h-[1.5px] before:bg-linear-(--gradient-horizontal) after:absolute after:z-3 after:h-[1.5px] after:bg-linear-(--gradient-horizontal)"
			></div>
		</div>
	</div>
);
